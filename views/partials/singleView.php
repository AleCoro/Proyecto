    ...
    <div class="container py-5">
      <div class="row pt-5">
        ...
        <div class="col-lg-4 mt-5 mt-lg-0">
          ...
          <!-- Single Image -->
          <div class="mb-5">
            <img src="views/img/blog-2.jpg" alt="" class="img-fluid rounded" />
          </div>
          ...
          <!-- Single Image -->
          <div class="mb-5">
            <img src="views/img/blog-3.jpg" alt="" class="img-fluid rounded" />
          </div>
