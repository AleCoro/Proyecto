      ...
      <div class="container">
        <div class="text-center pb-2">
          <p class="section-title px-5">
            <span class="px-2">Ponte en contacto</span>
          </p>
          <h1 class="mb-4">Contáctenos para cualquier consulta</h1>
        </div>
        <div class="row">
          ...
          <div class="col-lg-5 mb-5">
            <p>
              ¡Hola y gracias por visitar nuestra academia colaborativa! Estamos emocionados de saber que estás interesado en ponerte en contacto con nosotros. En [Nombre de la Academia], valoramos la comunicación abierta y estamos aquí para responder cualquier pregunta que puedas tener.
            </p>
            <div class="d-flex">
